...
/**int_tests**
Integration tests. Folder name based on the convention for unit test folders in Jest and extended to have int\_ at the start.
/**mocks**
...
sudo yum remove postgresql92 postgresql92-server
