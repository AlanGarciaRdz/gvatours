...
app.get('/TransportC/:uuid_transportC', transport_model.getTransportCById)
app.post('/TransportC', transport_model.createTransportC)
app.put('/TransportC/:uuid_transportC', transport_model.updateTransportC) 
app.delete('/TransportC/:uuid_transportC', transport_model.deleteTransportC)
