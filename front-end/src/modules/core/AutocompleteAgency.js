          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <DialogContent>
              ...
              <TextField
                ...
                onChange={event => this.setState({dialogValue: {...dialogValue, nombre_agencia: event.target.value }})}
                label="nombre"
                type="text"
              />
              <TextField
                ...
                onChange={event => this.setState({dialogValue: {...dialogValue, contacto: event.target.value }})}
                label="contacto"
                type="text"
              />
            </DialogContent>
